...
<xsl:template mode="mml2tex" match="m:mi|m:mn|m:mo|m:mtext|m:ms">
...
<xsl:template mode="mml2tex" match="m:mspace">
...
<xsl:template name="ms">
	...
	</xsl:choose><xsl:apply-templates mode="mml2tex"/><xsl:choose>
...
<xsl:template mode="mml2tex" match="m:*/text()">
