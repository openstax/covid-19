...
<xsl:template mode="mml2tex" match="m:mfrac">
	<xsl:choose>
...
<xsl:template mode="mml2tex" match="m:mroot">
	<xsl:choose>
...
<xsl:template mode="mml2tex" match="m:msqrt">
	<xsl:text>\sqrt{</xsl:text>
	<xsl:apply-templates mode="mml2tex"/>
	<xsl:text>}</xsl:text>
</xsl:template>

<xsl:template mode="mml2tex" match="m:mfenced">
	<xsl:choose>
		<xsl:when test="@open">
...
<xsl:template mode="mml2tex" match="m:mphantom">
	<xsl:text>\phantom{</xsl:text>
	<xsl:apply-templates mode="mml2tex"/>
	<xsl:text>}</xsl:text>
</xsl:template>

<xsl:template mode="mml2tex" match="m:menclose">
	<xsl:choose>
...
<xsl:template mode="mml2tex" match="m:mrow">
	<xsl:apply-templates mode="mml2tex"/>
</xsl:template>

<xsl:template mode="mml2tex" match="m:mstyle">
...
<xsl:template mode="mml2tex" match="m:merror">
	<xsl:apply-templates mode="mml2tex"/>
</xsl:template>
