...
<xsl:template mode="mml2tex" match="m:munderover">
...
<xsl:template mode="mml2tex" match="m:mover">
	<xsl:call-template name="mover">
...
<xsl:template mode="mml2tex" match="m:munder">
	<xsl:call-template name="munder">
		<xsl:with-param name="base">
			<xsl:call-template name="startspace">
				<xsl:with-param name="symbol" select="./*[1]"/>
...
-->
			<xsl:apply-templates mode="mml2tex" select="./*[1]"/>
			<xsl:text>^{</xsl:text>
			<xsl:apply-templates mode="mml2tex" select="./*[$pos_over]"/>
			<xsl:text>}</xsl:text>
		</xsl:when>
		<xsl:otherwise>
...
<xsl:template mode="mml2tex" match="m:msubsup">
	<xsl:text>{</xsl:text>	
	<xsl:apply-templates mode="mml2tex" select="./*[1]"/>
	<xsl:text>}_{</xsl:text>
	<xsl:apply-templates mode="mml2tex" select="./*[2]"/>
...
<xsl:template mode="mml2tex" match="m:msup">
	<xsl:text>{</xsl:text>	
	<xsl:apply-templates mode="mml2tex" select="./*[1]"/>
	<xsl:text>}^{</xsl:text>	
	<xsl:apply-templates mode="mml2tex" select="./*[2]"/>
...
<xsl:template mode="mml2tex" match="m:msub">
	<xsl:text>{</xsl:text>	
	<xsl:apply-templates mode="mml2tex" select="./*[1]"/>
	<xsl:text>}_{</xsl:text>	
	<xsl:apply-templates mode="mml2tex" select="./*[2]"/>
...
<xsl:template mode="mml2tex" match="m:mmultiscripts">
	<xsl:choose>
